...
namespace CMDR.Native
{
    internal enum SW : int
    {
        ...
        /// <summary> Activates and displays a window. If the window is minimized or maximized,
        /// the system restores it to its original size and position. An application should specify
        /// this flag when displaying the window for the first time. </summary>
        NORMAL = 1,
        ...
        /// SW_NORMAL, except that the window is not activated. </summary>
        SHOWNOACTIVATE = 4,
        ...
        /// except that the window is not activated. </summary>
        SHOWNA = 8,
        
        /// <summary> Activates and displays the window. If the window is minimized or maximized, the system
        /// restores it to its original size and position. An application should specify this flag when
        /// restoring a minimized window. </summary>
        RESTORE = 9,
        /// <summary> Sets the show state based on the SW_ value specified in the STARTUPINFO structure passed
        /// to the CreateProcess function by the program that started the application. </summary>
        SHOWDEFAULT = 10,
